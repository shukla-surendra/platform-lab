#!/usr/bin/env python3
"""End-to-end local RAG: retrieve top-K chunks from Qdrant, generate an answer with Ollama.

Mirrors ../rag_pgvector_local/rag.py and ../faiss_vector_db/rag.py, backed by Qdrant instead.
"""
