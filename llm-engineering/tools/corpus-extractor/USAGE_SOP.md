...
cp ~/books_extracted/dataset.txt ~/projects/2026/llm-engineering/from_scratch/custom-gpt-50m/data/books.txt
...
```bash
cd ~/projects/2026/llm-engineering/from_scratch/custom-gpt-50m
...
```bash
cd ~/projects/2026/llm-engineering/tools/corpus-extractor
cargo build --release
```
