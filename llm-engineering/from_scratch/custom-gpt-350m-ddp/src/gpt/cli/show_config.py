"""`gpt-config` — inspect the active model config, or compare every size preset.
...
from ..config import PRESETS, Paths, TrainConfig, load_settings, resolve_model_config
...
def print_presets():
    ...
    print()
    print("Select one with:  GPT_PRESET=<name> make train")
    print("Override a field: GPT_EMBED_SIZE=192 GPT_NUM_LAYERS=8 make train")
