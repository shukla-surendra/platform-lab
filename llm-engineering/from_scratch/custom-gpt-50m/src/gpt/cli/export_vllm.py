...
def main():
    ...
    if tokenizer.encode(DOCUMENT_SEPARATOR, add_special_tokens=False) != [config.eos_token_id]:
        raise RuntimeError("The exported GPT-2 tokenizer does not preserve the document separator token.")
