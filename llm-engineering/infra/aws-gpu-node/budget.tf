# A forgotten g6.xlarge is ~$19/day. This is the backstop for the case the idle
# watchdog cannot cover: an instance that is genuinely busy doing something you
# forgot you started, or storage/S3 cost drifting up on its own.
#
