...
variable "machine_type" {
  description = "GCP's G2 family bundles an L4 GPU directly into the machine type — no separate guest_accelerator block needed. g2-standard-4 = 4 vCPU, 16GB RAM, 1x L4 24GB, bf16 + TF32 — the direct analog of the AWS module's g6.xlarge default. Do not silently swap to an N1 + attached T4 to save money: no bf16, same reasoning as the AWS module's g4dn warning."
  type        = string
